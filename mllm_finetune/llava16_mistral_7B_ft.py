...
trainer = SFTTrainer(
    ...
    args = SFTConfig(
        ...
        run_name="llava16_7B_mistral_mmsd2_01",
        max_length = None,
...
model.save_pretrained("llava16_mistral_7B_mmsd2_outputs")
model.save_pretrained_merged("llava16_mistral_7B_mmsd2_outputs_merged", tokenizer, save_method = "merged_16bit")
# model.push_to_hub("sinngam-khaidem/llava16_mistral_7B_mmsd2", token = hf_token) # Online saving
# tokenizer.push_to_hub("sinngam-khaidem/llava16_mistral_7B_mmsd2", token = hf_token) # Online saving
# model.push_to_hub_merged("sinngam-khaidem/llava16_mistral_7B_mmsd2_merged", tokenizer, save_method = "merged_16bit",token = hf_token)
