...
model.push_to_hub("sinngam-khaidem/llama_32_11B_mmsd2", token = hf_token) # Online saving
tokenizer.push_to_hub("sinngam-khaidem/llama_32_11B_mmsd2", token = hf_token) # Online saving
model.push_to_hub_merged("sinngam-khaidem/llama_32_11B_mmsd2_merged", tokenizer, save_method = "merged_16bit",token = hf_token)
