...
trainer = SFTTrainer(
    ...
    args = SFTConfig(
        ...
        run_name="llava16_7B_vicuna_mmsd2_01",
        max_length = None,
...
model.save_pretrained("llava16_vicuna_7B_mmsd2_outputs")
model.save_pretrained_merged("llava16_vicuna_7B_mmsd2_outputs_merged", tokenizer, save_method = "merged_16bit")
