...
pipe = pipeline("image-text-to-text", model="/home/gpuuser3/sinngam_albert/work/mllm_finetune/llava16_vicuna_7B_mmsd2_outputs_merged")
...
if __name__ == "__main__":
    df = pd.read_csv("/home/gpuuser3/sinngam_albert/datasets/osint/batch_3.csv", dtype='str')
    df['image_path'] = df['image_id'].apply(
        lambda x: f"/home/gpuuser3/sinngam_albert/datasets/osint/batch_3/{x}.png"
    )
        ...
        try:
            ...
            if os.path.exists(sample['image_path']):
                ...
                append_to_json_output(
                    ...
                    output_file="gpt_predictions/llava16_vicuna_osint_batch_3.json"
                )
